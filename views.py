...
def home_view(request):
    ...
    return render(request,'tschool/index.html')
...
def adminclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'tschool/adminclick.html')
...
def teacherclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'tschool/teacherclick.html')
...
def studentclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'tschool/studentclick.html')
...
def admin_signup_view(request):
    ...
    return render(request,'tschool/adminsignup.html',{'form':form})
...
def student_signup_view(request):
    ...
    return render(request,'tschool/studentsignup.html',context=mydict)
...
def teacher_signup_view(request):
    ...
    return render(request,'tschool/teachersignup.html',context=mydict)
...
def afterlogin_view(request):
    if is_admin(request.user):
        ...
        if accountapproval:
            ...
            return render(request,'tschool/teacher_wait_for_approval.html')
    elif is_student(request.user):
        accountapproval=models.StudentExtra.objects.all().filter(user_id=request.user.id,status=True)
        if accountapproval:
            return redirect('student-dashboard')
        else:
            return render(request,'tschool/student_wait_for_approval.html')
...
def admin_dashboard_view(request):
    ...
    return render(request,'tschool/admin_dashboard.html',context=mydict)
...
def admin_teacher_view(request):
    return render(request,'tschool/admin_teacher.html')
...
def admin_add_teacher_view(request):
    ...
    return render(request,'tschool/admin_add_teacher.html',context=mydict)
...
def admin_view_teacher_view(request):
    ...
    return render(request,'tschool/admin_view_teacher.html',{'teachers':teachers})
...
def admin_approve_teacher_view(request):
    ...
    return render(request,'tschool/admin_approve_teacher.html',{'teachers':teachers})
...
def update_teacher_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if form1.is_valid() and form2.is_valid():
            ...
            f2.save()
            return redirect('admin-view-teacher')
    return render(request,'tschool/admin_update_teacher.html',context=mydict)
...
def admin_view_teacher_salary_view(request):
    ...
    return render(request,'tschool/admin_view_teacher_salary.html',{'teachers':teachers})
...
def admin_student_view(request):
    return render(request,'tschool/admin_student.html')
...
def admin_add_student_view(request):
    ...
    return render(request,'tschool/admin_add_student.html',context=mydict)
...
def admin_view_student_view(request):
    ...
    return render(request,'tschool/admin_view_student.html',{'students':students})
...
def update_student_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if form1.is_valid() and form2.is_valid():
            ...
            f2.save()
            return redirect('admin-view-student')
    return render(request,'tschool/admin_update_student.html',context=mydict)
...
def admin_approve_student_view(request):
    ...
    return render(request,'tschool/admin_approve_student.html',{'students':students})
...
def admin_view_student_fee_view(request):
    ...
    return render(request,'tschool/admin_view_student_fee.html',{'students':students})
...
def admin_attendance_view(request):
    return render(request,'tschool/admin_attendance.html')
...
def admin_take_attendance_view(request,cl):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'tschool/admin_take_attendance.html',{'students':students,'aform':aform})
...
def admin_view_attendance_view(request,cl):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return render(request,'tschool/admin_view_attendance_page.html',{'cl':cl,'mylist':mylist,'date':date})
        else:
            print('form invalid')
    return render(request,'tschool/admin_view_attendance_ask_date.html',{'cl':cl,'form':form})
...
def admin_fee_view(request):
    return render(request,'tschool/admin_fee.html')
...
def admin_view_fee_view(request,cl):
    ...
    return render(request,'tschool/admin_view_fee.html',{'feedetails':feedetails,'cl':cl})
...
def admin_notice_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            form.save()
            return redirect('admin-dashboard')
    return render(request,'tschool/admin_notice.html',{'form':form})
...
def teacher_dashboard_view(request):
    ...
    return render(request,'tschool/teacher_dashboard.html',context=mydict)
...
def teacher_attendance_view(request):
    return render(request,'tschool/teacher_attendance.html')
...
def teacher_take_attendance_view(request,cl):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'tschool/teacher_take_attendance.html',{'students':students,'aform':aform})
...
def teacher_view_attendance_view(request,cl):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            studentdata=models.StudentExtra.objects.all().filter(cl=cl)
            mylist=zip(attendancedata,studentdata)
            return render(request,'tschool/teacher_view_attendance_page.html',{'cl':cl,'mylist':mylist,'date':date})
        else:
            print('form invalid')
    return render(request,'tschool/teacher_view_attendance_ask_date.html',{'cl':cl,'form':form})
...
def teacher_notice_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'tschool/teacher_notice.html',{'form':form})
...
def student_dashboard_view(request):
    ...
    return render(request,'tschool/student_dashboard.html',context=mydict)
...
def student_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'tschool/student_view_attendance_ask_date.html',{'form':form})
...
def aboutus_view(request):
    return render(request,'tschool/aboutus.html')
...
def contactus_view(request):
    ...
    return render(request, 'tschool/contactus.html', {'form':sub})